...
let EmailService = EmailService_1 = class EmailService {
    ...
    getNewLeadEmailHtml(lead, listing) {
        return `
      <!DOCTYPE html>
      <html>
      <head>
    ...
    getVisitConfirmationEmailHtml(visit, listing) {
    ...
    getVisitReminderEmailHtml(visit, listing, hoursUntil) {
        const visitDate = new Date(visit.scheduledAt).toLocaleDateString('en-US', {
            weekday: 'long',
            month: 'long',
            day: 'numeric',
    ...
    getListingApprovedEmailHtml(listing) {
        return `
      <!DOCTYPE html>
      <html>
      <head>
    ...
    getListingRejectedEmailHtml(listing, reason) {
        return `
      <!DOCTYPE html>
      <html>
      <head>
